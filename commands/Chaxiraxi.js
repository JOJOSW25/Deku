...
module.exports = {
    run: message => {
        message.channel.send(new Discord.MessageEmbed()
            .setTitle('Evenement')
            .setTitle('**Anniversaire de Chaxiraxi.**')
            .setDescription('**24 août**')
            .setColor('RANDOM')
            ...
            .setFooter('18 ans', 'https://cdn.discordapp.com/attachments/764885784833949717/766625624311332874/download.jpg')
            .setTimestamp())
    },
    name: 'chaxiraxi'
}